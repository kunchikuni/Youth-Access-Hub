/**
 * Opportunities List Loading Skeleton
 * Shown automatically by Next.js while the opportunities table page
 * fetches data from Supabase.
 *
 * @module app/admin/(dashboard)/opportunities/loading
 */
    ...
    <div className="skel-list-root">
      ...
      <div className="skel-table">
        <div className="skel-table-head">
          {["Title", "Category", "Provider", "Status", "Featured", "Deadline", "Actions"].map((label) => (
        ...
        {[0, 1, 2, 3, 4].map((i) => (
          <div key={i} className="skel-table-row">
            <div className="skel-td">
              <div className="skel-line" style={{ width: "75%", height: "0.9375rem", marginBottom: "0.25rem" }} />
              <div className="skel-line" style={{ width: "50%", height: "0.6875rem" }} />
            </div>
      ...
      <style>{`
        ...
        .skel-line--title { width: 170px; height: 1.375rem; margin-bottom: 0.5rem; }
        .skel-line--sub   { width: 130px; height: 0.875rem; }
        ...
        .skel-table-head {
          display: grid;
          grid-template-columns: 1.8fr 0.9fr 1.2fr 0.9fr 0.9fr 0.9fr 1.4fr;
          gap: 1rem;
        ...
        @media (max-width: 768px) {
          ...
          .skel-table-head > :nth-child(3),
          .skel-table-head > :nth-child(5),
          .skel-table-head > :nth-child(6),
          .skel-table-row > :nth-child(3),
          .skel-table-row > :nth-child(5),
          .skel-table-row > :nth-child(6) {
            display: none;
          }
        }
      `}</style>
