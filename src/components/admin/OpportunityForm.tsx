 ...
 *
 * Handles:
 *  - All Opportunity fields including eligibility[] dynamic list
 *  - Cover image upload to Supabase Storage (yah-media/opportunities/)
  ...
  return (
    <form onSubmit={handleSubmit} className="of-form" noValidate>
      ...
      <div className="of-card">
        ...
        <div className="of-field" data-error={errors.description || undefined}>
          ...
          <textarea id="description" value={description}
            ...
            placeholder="Full description shown on the opportunity detail page…" rows={5} />
        ...
        {imagePreview ? (
          ...
          <label className="of-image-drop" htmlFor="cover-image">
            ...
            <input id="cover-image" type="file"
              ...
              onChange={handleImageChange} className="of-sr-only" />
          </label>
        )}
      </div>
      ...
      <div className="of-actions">
        ...
        <button type="submit" className="of-submit-btn" disabled={saving || uploadingImage}>
